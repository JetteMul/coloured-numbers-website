...
class About extends PageViewElement {
  render() {
    return html`
      ...
      <section>
        <h2>About me</h2>
        <p>Een jettie mullie specialised in Javascript. Both frontend oriented and backend oriented. Frontend: worked with webcomponents, PWA and the popular JS frameworks. Backend: NodeJS</p>
