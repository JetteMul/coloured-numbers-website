  ...
  render() {
    return html`
      ...
      <section>
        ...
        <p>Those tests will run on every commit via <a href="https://travis-ci.com/iceicerickert/coloured-numbers-website" target="_blank">Travis CI</a>.</p>
        ...
        <p><a href="https://sonarcloud.io/" target="_blank">Sonarcloud</a> is used for code analysis, the <a href="https://sonarcloud.io/dashboard?id=coloured-numbers-website" target="_blank">current state</a> of <code>this</code> website is openly available.</p>
